...
void ClientModel::subscribeToCoreSignals()
{
    ...
    uiInterface.NotifyBlocksChanged.connect(boost::bind(NotifyBlocksChanged, this, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3));
...
void ClientModel::unsubscribeFromCoreSignals()
{
    ...
    uiInterface.NotifyBlocksChanged.disconnect(boost::bind(NotifyBlocksChanged, this, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3));
...
{
    // Connect signals to client
    uiInterface.NotifyBlocksChanged.connect(boost::bind(NotifyBlocksChanged, this, _1, _2, _3));
    uiInterface.BannedListChanged.connect(boost::bind(BannedListChanged, this));
...
{
    // Disconnect signals from client
    uiInterface.NotifyBlocksChanged.disconnect(boost::bind(NotifyBlocksChanged, this, _1, _2, _3));
    uiInterface.BannedListChanged.disconnect(boost::bind(BannedListChanged, this));
